...
const cartReducer = (state, action) => {
  ...
  switch (type) {
    case CART_ACTION_TYOES.SET_CART_ITEMS:
      return {
        ...state,
        ...payload
      };
    case CART_ACTION_TYOES.SET_IS_CART_OPEN:
      return {
        ...state,
        isCartOpen: payload
      }
...
export const CartProvider = ({ children }) => {
  ...
  const updateCartItemsReducer = (newCartItems) => {
    ...
    dispatch(createAction(CART_ACTION_TYOES.SET_CART_ITEMS, {
  ...
  const setIsCartOpen = (bool) => {
    dispatch(createAction(CART_ACTION_TYOES.SET_IS_CART_OPEN, bool))
  }
