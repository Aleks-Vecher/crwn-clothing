...
export const signUpSuccess = (user, additionalDetails) => createAction(USER_ACTION_TYPES.SIGN_UP_SSUCCESS, { user, additionalDetails })
export const signUpFaild = (error) => createAction(USER_ACTION_TYPES.SIGN_UP_FAILED, error)
export const signOutStart = () => createAction(USER_ACTION_TYPES.SIGN_OUT_START)
export const signOutSuccess = () => createAction(USER_ACTION_TYPES.SIGN_OUT_SSUCCESS)
export const signOutFaild = (error) => createAction(USER_ACTION_TYPES.SIGN_OUT_FAILD, error)
