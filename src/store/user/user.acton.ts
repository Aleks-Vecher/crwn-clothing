...
export type SignUpSuccess = ActionWithPayload<
  USER_ACTION_TYPES.SIGN_UP_SSUCCESS,
...
export type SignOutSuccess = Action<USER_ACTION_TYPES.SIGN_OUT_SSUCCESS>;
...
export const signUpSuccess = withMatcher(
  (user: User, additionalDetails: AdditionalInformation): SignUpSuccess =>
    createAction(USER_ACTION_TYPES.SIGN_UP_SSUCCESS, { user, additionalDetails })
);
...
export const signOutSuccess = withMatcher(
  (): SignOutSuccess => createAction(USER_ACTION_TYPES.SIGN_OUT_SSUCCESS)
);
